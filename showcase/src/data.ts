export const groups = [
  {
    ...
    components: ['GlowCard', 'RotatingGlowCard', 'MagneticButton', 'JellyButton', 'Hover3DCard', 'ClickSpark', 'LightRays', 'SplashCursor', 'Backlight', 'PixelImage', 'AmbientImage', 'Lens', 'ImagesSlider'],
  },
  {
    path: '/text',
    title: 'Text & Motion',
  ...
  },
  {
    ...
    components: ['Checkbox', 'Switch', 'Slider', 'AutocompleteCell', 'AnimatedSearch', 'ImageUpload', 'PasswordConfirmation', 'PasswordSetup'],
  },
  {
    path: '/feedback',
    title: 'Feedback',
