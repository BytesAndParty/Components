  ...
  return (
    <section className="bg-background py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="bg-card border-border relative isolate overflow-hidden rounded-3xl border px-6 py-16 shadow-2xl sm:px-24 sm:py-24 xl:py-32">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <BlurFade delay={300} className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="/mehr-erfahren" className="text-foreground hover:text-accent-readable text-sm leading-6 font-semibold transition-colors">
