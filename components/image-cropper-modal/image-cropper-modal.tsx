            ...
            {imageSrc ? (
              ...
              >
                ...
                <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-border">
                  ...
                  <ApplyButton onCrop={onCrop} onClose={() => onOpenChange(false)} />
                </div>
              </ImageCropper.Root>
            ) : (
...
function CropperControls() {
  ...
  return (
    <div className="flex items-center gap-1 flex-1">
      {/* Zoom */}
      <button type="button" title="Zoom out" onClick={() => api.setZoom(api.zoom - 0.1)}
      ...
      <button type="button" title="Zoom in" onClick={() => api.setZoom(api.zoom + 0.1)}
        className={iconBtnCls}>
        <ZoomIn size={14} />
      </button>
