...
Diese Übersicht dient als Schnellreferenz für den Aufbau von Premium-Storefronts und Landingpages. Alle Komponenten sind für React 19 / React Compiler optimiert.
...
- **color-picker:** Hochwertiger OKLCH-Farbwähler.
- **image-cropper-modal:** Bildbearbeitung mit Ark UI.
- **layer-panel:** Ebenen-Management mit Drag-Reorder.
...
- **form-input / gooey-input:** Organische Eingabefelder.
- **search-overlay / animated-search:** Schnelle, intelligente Suche.
- **slider / switch / checkbox:** Headless-Interaktionen (Ark UI).
...
- **stepper:** Fortschrittsanzeige für mehrstufige Prozesse.
- **circular-progress:** Animierte Ladezustände.
- **countdown:** Dringlichkeit für limitierte Angebote.
- **hotkeys:** Tastatursteuerung für Power-User.
- **timeline:** Storytelling für Marken-Historie.
- **i18n / language-switcher / accent-switcher:** Globalisierung und Personalisierung.

---
*Status: Scanning abgeschlossen (2026-05-26). Bereit für den Section-Showcase.*
