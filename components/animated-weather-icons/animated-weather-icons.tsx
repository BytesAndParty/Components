...
export function CloudIcon({ size = 48, className, style }: WeatherIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} style={style}>
...
export function RainIcon({ size = 48, className, style }: WeatherIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} style={style}>
...
export function SnowIcon({ size = 48, className, style }: WeatherIconProps) {
...
export function ThunderIcon({ size = 48, className, style }: WeatherIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} style={style}>
...
export function WindIcon({ size = 48, className, style }: WeatherIconProps) {
...
export function FogIcon({ size = 48, className, style }: WeatherIconProps) {
...
export function PartlyCloudyIcon({ size = 48, className, style }: WeatherIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} style={style}>
...
export function SunriseIcon({ size = 48, className, style }: WeatherIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} style={style}>
...
export function RainbowIcon({ size = 48, className, style }: WeatherIconProps) {
  const arcs = [
    { r: 16, color: '#EF4444' },
    { r: 13, color: '#F59E0B' },
    { r: 10, color: '#22C55E' },
...
export function HeavyRainIcon({ size = 48, className, style }: WeatherIconProps) {
